! function(t, e) {"use strict";
	"object" == typeof module && "object" == typeof module.exports && (module.exports = t.document ?
	void 0 : function(t) {
		if (!t.document)
			throw new Error("jQuery requires a window with a document")
	})
}("undefined" != typeof window ? window : this), function(t) {"use strict";
	t.breakingNews = function(e, i) {
		...
		n.settings = {};
		var r = t(e), o = ( e = e, r.children(".bn-label")), a = r.children(".bn-news"), l = a.children("ul"), c = l.children("li"), d = r.children(".bn-controls"), f = d.find(".bn-prev").parent(), h = d.find(".bn-action").parent(), u = d.find(".bn-next").parent(), g = !1, p = !0, m = l.children("li").length, b = 0, y = !1, w = function() {
		...
		n.init = function() {
			if (n.settings = t.extend({}, s, i), "fixed-top" === n.settings.position ? r.addClass("bn-fixed-top").css({
				...
				}), r.addClass("bn-effect-" + n.settings.effect + " bn-direction-" + n.settings.direction), w(), "object" == typeof n.settings.source)
					...
					case"rss":
						"rss2json" === n.settings.source.usingApi ? (( d = new XMLHttpRequest).onreadystatechange = function() {
							if (4 == d.readyState && 200 == d.status) {
								...
								void 0 !== typeof n.settings.source.seperator && ( s = n.settings.source.seperator);
							...
							if (4 == e.readyState)
								if (200 == e.status) {
									...
									void 0 !== n.settings.source.seperator && ( r = n.settings.source.seperator);
				...
				"html" === n.settings.source ? ("scroll" != n.settings.effect && q(), x()) : console.log('Please check your "source" parameter. Incorrect Value');
			var e, d;
