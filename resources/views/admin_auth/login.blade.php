            ...
            <form class="login-form" action="{{ url('/admin/login') }}" method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="input-icon">
                        ...
                        <input id="email" type="email" class="form-control placeholder-no-fix" name="email" value="{{ old('email') }}" value="Email address" autofocus>

                        @if ($errors->has('email'))
                            <span>
                                <p style="background-color: white!important;" class="error-msg">{{ $errors->first('email') }}</p>
                            </span>
                        @endif
                ...
                <div class="form-group">
                    ...
                    <div class="input-icon">
                        ...
                        @if($errors->has('password'))
                            <span>
                                <p style="background-color: white!important;" class="error-msg">{{ $errors->first('password') }}</p>
                            </span>
                        @endif
