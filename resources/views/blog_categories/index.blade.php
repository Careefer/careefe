...
<div class="page-content">
        <!-- <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <span>Create New Blog Category</span>
                </li>
            </ul>
        </div> -->
        <div class="row">
                ...
                <div class="portlet light bordered">
                    <div class="portlet-title">
                        <div class="caption font-dark">
                            <h4 class="caption-subject bold uppercase"><i class="fa fa-list"></i>&nbspBlog Category
                            </h4>
                        </div>
                        <div class="actions">
                            <div class="btn-group">
                               <button class="btn sbold green" onclick="redirect_url($(this),'{{ route('blog_categories.blog_category.create') }}');"><i class="fa fa-plus"></i>
                            ...
                            <table class="table table-striped table-bordered table-hover dt-responsive table-checkable service-table" id="datatable_ajax">
                                <thead>
                                    <tr role="row" class="heading">    
                                        <th width="400" class="all">Category Name</th>
                                        <th width="400" class="tablet-p tablet-l desktop">Status</th>
                                        <th width="400" class="tablet-p tablet-l desktop">Action</th>
                                    </tr>
...
@push('scripts')
    <script>
        jQuery(document).ready(function() {
            ...
            var export_columns = [0,1,];

            var file_name = 'BLOG CATEGORY';
