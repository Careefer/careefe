...
@section('title','Candidate Password Reset Link')
    ...
    <div class="signin-wrapper sign-in">
        ...
        <div class="tabs-wrapper">
            <ul class="signin-tabs clearfix tabs">
                <li class="tab-link current" data-tab="candidate-tab">
                    Candidate/Referee
                </li>
            ...
            <div id="candidate-tab" class="tab-content current">
                <form id="candidate_pass_resetlink_frm" class="signin-form form" role="form" method="POST" action="{{ url('/candidate/password/email') }}" autocomplete="off">
                        {{ csrf_field() }}
