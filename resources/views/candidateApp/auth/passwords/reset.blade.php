...
@section('title','Candidate Forgot Password')
@section('content')
<!-- <div class="container">
    <div class="row">
    ...
    <div class="signin-wrapper sign-in">
        ...
        <div class="tabs-wrapper">
            ...
            <div id="candidate-tab" class="tab-content current">
                ...
                <form id="candidate_pass_rest_frm" class="signin-form form" role="form" method="POST" action="{{ url('/candidate/password/reset') }}">
                    {{ csrf_field() }}
