...
<div class="refer-tabs-content">
	<div id="pay-content" class="refer-content refer-common refer-current">
		@if($jobs->count())
			...
			<div class="project-job">
				<div class="pay-top">
					<div class="project-details top-desktop">
						<div class="left-detail">
							...
							<h4 class="apache-img apche-wrap" onclick="redirect_url($(this),'{{route('web.company.detail',[$obj_job->company->slug])}}',null,true)"><img src="{{ asset('assets/web/images/l.png') }}"
						...
						<a class="ref-button" href="{{ route('candidate.payment-history-detail', [$obj_job->id]) }}"> button </a>
					</div>
					<div class="project-details top-mobile">
						<div class="left-detail">
							...
							<div class="sent-referral-wrap">
								<strong class="apache-img apche-wrap project-price"><span class="dollar-icon">$</span>{{number_format($obj_job->salary_min) }}  - {{number_format($obj_job->salary_max) }}</strong>
								<ul class="ref-total">
									<li>
										Successful Referral: {{ $obj_job->candidate_referral_receive_applications->count() }}
									</li>
				...
				<div class="pay-bottom">
					<ul class="pay-list">
						<li>
							<span>Total Paid:</span><strong>$ {{ $obj_job->getCandidateTotalPayment() }}</strong>
						</li>
						<li>
							<span>Total Outstanding:</span><strong>$ {{ $obj_job->getCandidateOutstandingPayment() }}</strong>
						</li>
					</ul>
				</div>
			</div>
