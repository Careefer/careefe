<div class="profile-content profile-current referrals referrals-sent" id="referral-tab">
	<div class="profile-content-inner shadow">
		@if($page == 'sent-detail')
		<div class="btn-back">
			<a href="{{ route('candidate.referral', ['sent']) }}"><img src="{{ asset('assets/images/back-btn.png') }}" alt="back">Back</a>
		</div>
		@elseif($page == 'receive-detail')
		<div class="btn-back">
			<a href="{{ route('candidate.referral', ['received']) }}"><img src="{{ asset('assets/images/back-btn.png') }}" alt="back">Back</a>
		</div>
		@endif
					...
					<div class="project-outer clearfix">
						...
						<div class="project-details top-mobile">
							<div class="left-detail">
								...
								<h3>{{optional($job->position)->name}}</h3>
								@if($job->company->company_name)
								<h4 class="apache-img apche-wrap" onclick="redirect_url($(this),'{{route('web.company.detail',[$job->company->slug])}}',null,true)"><img src="{{ asset('assets/web/images/company.svg') }}"
								alt="company">{{ $job->company->company_name }}</h4>
								@endif
						...
						@if($page == 'sent-detail')	
						@include('candidateApp.referral-detail.include.application_card')
						@elseif($page == 'receive-detail')
						@include('candidateApp.referral-detail.include.application_receive_card')
						@endif
						</div>
					</div>
				</div>
