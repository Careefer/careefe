...
<div class="refer-tabs-content">
	<div id="sent-content" class="refer-content refer-current sent-detail refer-common">
		@if($jobs->count())
					...
					<div class="project-details top-desktop">
						<div class="left-detail">
							...
							<h4 class="apache-img apche-wrap"
							 onclick="redirect_url($(this),'{{route('web.company.detail',[$obj_job->company->slug])}}',null,true)
							 "><img src="{{ asset('assets/images/loc-img2.png') }}"
							...
							<div class="sent-referral-wrap">
								...
								<span class="ref-no">Referral Sent: {{ $obj_job->candidate_referral_sent_applications->count() }}</span>
							</div>
						</div>
						<div class="right-detail">
							...
							src="{{$logo_path}}" alt="project-apache">
							</a>
						...
						<a class="ref-button" href="{{ route('candidate.referral-sent-detail', [$obj_job->id])}}"> button </a>
					</div>
