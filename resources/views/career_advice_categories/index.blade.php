                ...
                <div class="portlet light bordered">
                    <div class="portlet-title">
                        <div class="caption font-dark">
                            <h4 class="caption-subject bold uppercase"><i class="fa fa-list"></i>&nbspCareer Advice Categories
                            </h4>
                        </div>
                        <div class="actions">
                            <div class="btn-group">
                                <button class="btn sbold green" onclick="redirect_url($(this),'{{ route('career_advice_categories.career_advices.create') }}');"><i class="fa fa-plus"></i>
                                Create New Category
                                </button>
                            </div>
                        </div>
                            ...
                            <table class="table table-striped table-bordered table-hover dt-responsive table-checkable service-table" id="datatable_ajax">
                                <thead>
                                    <tr role="row" class="heading">
                                        <th width="500" class="all">Category Name</th>
                                        <th width="500" class="tablet-l desktop">Status</th>
                                        <th width="500" class="tablet-l desktop">Action</th>
                                    </tr>
                                    <tr class="filter" role="row">   
                                        ...
                                        <td rowspan="1" colspan="1">
                                           <div class="margin-bottom-5">
                                            <input type="text" placeholder="Category Name" name="title" class="form-control form-filter input-sm">
                                            </div>
                                        </td>
                                        <td rowspan="1" colspan="1">
                                           <div class="margin-bottom-5">
