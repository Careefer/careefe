            ...
            <div class="portlet light bordered"> 
                <div class="portlet-title">
                    <div class="caption font-dark">
                        <h4 class="caption-subject bold uppercase"><i class="fa fa-list"></i>&nbspCareer Advice
                        </h4>
                    </div>
                    <div class="actions">
                        <div class="btn-group">
                            <button class="btn sbold green" onclick="redirect_url($(this),'{{ route('career_advices.career_advice.create') }}');"><i class="fa fa-plus"></i>
                                Create New Career Advice
                            </button>
                        </div>
                    </div>
                    @if(session('error'))    
                        ...
                        <table class="table table-striped table-bordered table-hover dt-responsive table-checkable service-table" id="datatable_ajax">
                            <thead>
                                <tr role="row" class="heading">
                                    <th width="350" class="all">Category</th>
                                    <th width="200" class="tablet-l desktop">Title</th>
                                    <th width="200" class="tablet-l desktop">Image/Video</th>
