            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="portlet-title">
                        <div class="caption">
                            <h4 class="caption-subject bold uppercase">
                                <i class="fa fa-plus"></i>&nbspCreate New Country
                            </h4>
                        </div>
                    </div>
                    ...
                    <div class="portlet-body form margin-top-25">
                        <form method="POST" action="{{ route('countries.country.store') }}" accept-charset="UTF-8" id="create_country_form" name="create_country_form">
                            <div class="form-body">
                                {{ csrf_field() }}
