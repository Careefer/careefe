...
@section('title','Employer Password Reset Link')
<!-- Main Content -->
@section('content')
<!-- <div class="container">
    <div class="row">
    ...
    <div class="signin-wrapper sign-in">
        ...
        <div class="tabs-wrapper">
            ...
            <div id="employer-tab" class="tab-content current">
                <form id="candidate_pass_resetlink_frm" class="signin-form form" role="form" method="POST" action="{{ url('/employer/password/email') }}" autocomplete="off">
                        {{ csrf_field() }}
