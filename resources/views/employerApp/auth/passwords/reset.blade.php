...
@section('title','Employer Forgot Password')
@section('content')
<!-- <div class="container">
    <div class="row">
    ...
    <div class="signin-wrapper sign-in">
        ...
        <div class="tabs-wrapper">
            <ul class="signin-tabs clearfix tabs">
                ...
                <li class="tab-link" data-tab="employer-tab" onclick="redirect_url($(this),'{{ route('specialist.login') }}');">
                    Specialist
                </li>
            ...
            <div id="employer-tab" class="tab-content current">
                
                <form id="employer_pass_rest_frm" class="signin-form form" role="form" method="POST" action="{{ url('/employer/password/reset') }}">
                    {{ csrf_field() }}
                    ...
                    <button type="button" class="login-btn button" onclick="submit_form($(this),$('#employer_pass_rest_frm'))">
                        Reset Password
                    </button>
                </form>
            </div>
