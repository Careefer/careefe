                    ...
                    <div class="portlet-title">
                        <div class="caption font-dark">
                            ...
                            <span class="caption-subject bold">
                                {{$obj_emp->company_name}} &nbsp (Associated Accounts)
                            </span>
                        </div>
                        <div class="actions">
                            <div class="btn-group">
                                <button onclick="redirect_url($(this),'{{route("admin.create_associated_acc",[$obj_emp->id])}}')" class="btn sbold green">
                            ...
                            <table class="table table-striped table-bordered table-hover dt-responsive table-checkable service-table" id="datatable_ajax">
                                <thead>
                                    <tr role="row" class="heading">
                                        <th width="400" class="all">
                                            Employer id
                                        </th>
                                        <th width="400" class="all">
                                            Name
                                        </th>
                                        <th width="350" class="tablet-l desktop">Email</th> 
                                        <th width="350" class="tablet-l desktop">Contact No</th> 
                                        <th width="100">Location </th>
                                        <th width="250" class="tablet-p tablet-l desktop">Currency </th>
                                        <th width="250" class="tablet-p tablet-l desktop">Timezone</th>
                                    ...
                                    <tr class="filter" role="row">
                                        ...
                                        <td rowspan="1" colspan="1">
                                            <div class="margin-bottom-5">
                                                <input type="text" placeholder="Contact No" name="mobile" class="form-control form-filter input-sm">
                                            </div>
                                        </td>
...
@push('scripts')
    <script>
        jQuery(document).ready(function() {
            sort_arr = [
                {data: 'employer_id', name: 'employer_id', "bSortable": false},
				{data: 'name', name: 'name', "bSortable": true},
				{data: 'email', name: 'email', "bSortable": true},
				{data: 'mobile', name: 'mobile', "bSortable": true},
				{data: 'my_location.location', name: 'my_location.location', "bSortable": true},
                {data: 'currency.name', name: 'currency.name', "bSortable": true},
                {data: 'timezone.name', name: 'timezone.name', "bSortable": true},
				{data: 'status', name: 'status', "bSortable": true},
                {data: 'created_at', name: 'created_at', "bSortable": true},
				{data: 'action', name: 'action', "bSortable": true, searchable: false}
			];

            default_sort_column = [[7, "desc"]];
