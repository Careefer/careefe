            ...
            <div class="col-md-12">
                <div class="portlet-title">
                    <div class="caption font-dark">
                        <h4 class="caption-subject bold uppercase"><i class="fa fa-list"></i>&nbspMessages
                        </h4>
                    </div>
                    <div class="actions">
                        {{--<div class="btn-group">
                        ...
                        <table class="table table-striped table-bordered table-hover dt-responsive table-checkable service-table" id="datatable_ajax">
                            <thead>
                                <tr role="row" class="heading">
                                    <th width="200" class="all">Sender Name</th>
                                    <th width="350" class="tablet-p tablet-l desktop">Message</th>
                                    <th width="350" class="tablet-p tablet-l desktop">User Type</th>
                                    <th width="350" class="tablet-p tablet-l desktop">Job Card</th>
                                    <th width="350" class="tablet-p tablet-l desktop">Application Card</th>
    ...
    <script>
        jQuery(document).ready(function() {
            ...
            sort_arr = [
                ...
                {data: 'message', name: 'message', "bSortable": true},
                {data: 'user_type', name: 'user_type', "bSortable": false},
                {data: 'job_card', name: 'job_card', "bSortable": false},
                {data: 'application_card', name: 'application_card', "bSortable": false},
                {data: 'date', name: 'date', "bSortable": true},
