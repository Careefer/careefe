                    ...
                    <div class="portlet-title">
                        <div class="caption">
                            <h4 class="caption-subject bold uppercase">
                                <i class="fa fa-edit"></i>&nbspUpdate Newsletter
                            </h4>
                        </div>
                    </div>

                    <div class="portlet-body form margin-top-25">
                        <form method="POST" action="{{ route('newsletters.newsletter.update', $newsletter->id) }}" id="edit_newsletter_form" name="edit_newsletter_form" accept-charset="UTF-8"  enctype="multipart/form-data">
                            ...
                            <div class="form-actions noborder">
                                ...
                                <button type="submit" class="btn blue" onclick='submit_form($(this),$("#edit_newsletter_form"))'>
                                    Update
                                </button>
