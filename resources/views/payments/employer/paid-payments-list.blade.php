            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption font-dark">
                        ...
                        <span class="caption-subject bold uppercase">Employer Paid Payments
                        </span>
                    </div>
                </div>
                        ...
                        <table class="table table-striped table-bordered table-hover dt-responsive table-checkable service-table" id="datatable_ajax">
                            <thead>
                                ...
                                <tr class="filter" role="row">
                                        ...
                                        <td>
                                            <input type="text" placeholder="Transaction Id" name="transaction_id" class="form-control form-filter input-sm">
                                        </td>
                                        <td>
...
@push('scripts')
    <script>
        jQuery(document).ready(function() {
            ...
            var file_name = 'Employer Paid Payments';
