            ...
            <div class="col-md-12">
                <div class="portlet light portlet-fit portlet-form bordered">
                    ...
                    <div class="portlet-body">
                        <form class="form-horizontal" method="POST" action="{{ route('admin.import-payment-csv') }}" accept-charset="UTF-8" id="import_csv" name="import_csv" enctype="multipart/form-data">
 ...
 -->
                                ...
                                <div class="form-group">
                                    <div class="col-md-8 text-center">
                                        ...
                                        <button type="button" class="btn red" onclick="redirect_url($(this),'{{ route('admin.employer-payment-unpaid') }}')">Cancel
                                        </button>
                                    </div>
                                </div>
                            </div>
