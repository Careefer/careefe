            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption font-dark">
                        ...
                        <span class="caption-subject bold uppercase">Employer UNPaid Payments
                        </span>
                    </div>
                </div>
                <div class="portlet-body">
                    <div class="table-container">
                        <div class="table-actions-wrapper">
                            ...
                            <button class="btn btn-sm green" onclick="redirect_url($(this),'{{ route('admin.payment-status-update-by-csv') }}');"><i class="fa fa-plus"></i>
                                        Import
                            </button> 
                        ...
                        <table class="table table-striped table-bordered table-hover dt-responsive table-checkable service-table" id="datatable_ajax">
                            <thead>
                                <tr role="row" class="heading">
                                    <th width="200" class="none">Payment Id</th>
                                    <th width="200" class="all">Job ID</th> 
                                    <th width="200" class="tablet-p tablet-l desktop">Postion</th>
                                    <th width="200" class="tablet-p tablet-l desktop">Job Location</th> 
                                    <th width="200" class="tablet-p tablet-l desktop">Employer Name</th>
                                    <th width="200" class="tablet-p tablet-l desktop">Careefer Commission %</th>
                                    <th width="200" class="tablet-p tablet-l desktop">Applicant's Name</th>
                                    <th width="200" class="tablet-p tablet-l desktop">Payment Status</th>
                                    <th width="100" class="tablet-p tablet-l desktop">Actions</th>
                                </tr>
...
@push('scripts')
    <script>
        jQuery(document).ready(function() {
            ...
            var file_name = 'Employer Unpaid Payments';
