            ...
            <div class="col-md-12">
                <div class="portlet light portlet-fit portlet-form bordered">
                    ...
                    <div class="portlet-body">
                        <form class="form-horizontal" method="POST" action="{{ route('admin.referee-update-payment-status') }}" accept-charset="UTF-8" id="import_csv" name="import_csv" enctype="multipart/form-data">
 ...
 -->
                                ...
                                <div class="form-group">
                                    <div class="col-md-8 text-center">
                                        ...
                                        <button type="button" class="btn red" onclick="redirect_url($(this),'{{ route('admin.referee-unpaid-payment') }}')">Cancel
                                        </button>
                                    </div>
                                </div>
                            </div>
