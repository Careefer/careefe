            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption font-dark">
                        ...
                        <span class="caption-subject bold uppercase">Referee Unpaid Payments
                        </span>
                    </div>
                </div>
                <div class="portlet-body">
                    <div class="table-container">
                        <div class="table-actions-wrapper">
                            ...
                            <button class="btn btn-sm green" onclick="redirect_url($(this),'{{ route('admin.referee-payment-status') }}');"><i class="fa fa-plus"></i>
                                        Import
                            </button>  
                        ...
                        <table class="table table-striped table-bordered table-hover dt-responsive table-checkable service-table" id="datatable_ajax">
                            <thead>
                                <tr role="row" class="heading">
                                    ...
                                    <th width="200" class="tablet-p tablet-l desktop">Referral Bonus amount</th>
                                    <th width="200" class="tablet-p tablet-l desktop">Referee Name</th>
                                    ...
                                    <th width="0" class="none">Payment Id</th>
                                </tr>
...
@push('scripts')
    <script>
        jQuery(document).ready(function() {
            ...
            var export_columns = [9,0,1,2,3,4,5,6,7];

            var file_name = 'Referee Unpaid Payments';
