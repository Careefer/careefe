            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption font-dark">
                        ...
                        <span class="caption-subject bold uppercase">Specialist Payment Summary
                        </span>
                    </div>
                </div>
                        ...
                        <table class="table table-striped table-bordered table-hover dt-responsive table-checkable service-table" id="datatable_ajax">
                            <thead>
                                <tr role="row" class="heading">
                                    <th width="200" class="all">Specialist Name</th> 

                                    <th width="350" class="tablet-p tablet-l desktop">Specialist Country</th> 
                                ...
                                <tr class="filter" role="row">
                                        ...
                                        <td>
                                            <input type="text" placeholder="Specilist Name" name="name" class="form-control form-filter input-sm">
                                        </td>
                                        <td>
    ...
    <script>
        jQuery(document).ready(function() {
            var sort_arr = [
                            ...
                            {
                                data: 'specilist.country',
                                name: 'specilist.country',
                                "bSortable":true
                            },
                            {
                                data: 'total_paid',
            ...
            var file_name = 'Specialist Payments';
