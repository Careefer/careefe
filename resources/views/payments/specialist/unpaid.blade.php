                ...
                <div class="portlet-body">
                    <div class="table-container">
                        <div class="table-actions-wrapper">
                            ...
                            <button class="btn btn-sm green" onclick="redirect_url($(this),'{{ route('admin.specialist-payment-status') }}');"><i class="fa fa-plus"></i>
                                        Import
                            </button> 
...
@push('scripts')
    <script>
        jQuery(document).ready(function() {
            ...
            var file_name = 'Specialist Unpaid Payments';
