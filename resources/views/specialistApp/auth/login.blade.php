...
@section('title','Specialist Login')
@section('content')
    ...
    <div class="signin-wrapper sign-in">
        ...
        <div class="tabs-wrapper">
            ...
            <div id="user-login-tab" class="tab-content current">
                ...
                <form class="signin-form form" id="candidate_login_form" role="form" method="POST" action="{{ url('/specialist/login') }}" autocomplete="off">
                    {{ csrf_field() }}
                    ...
                    <div class="checkbox-wrapper clearfix">
                        ...
                        <a href="{{ url('/specialist/password/reset') }}" class="forgot-pass">Forgot Password?</a>
                    </div>
                    <button type="button" class="login-btn button" onclick="submit_form($(this),$('#candidate_login_form'))">
                        Sign In
                    </button>
                </form>
                <span class="no-account">Don’t have an account? <a href="{{route('specialist.register')}}" class="register-link">Sign Up</a></span>
