              ...
              <div class="project-job">
                <div class="pay-top">
                  <div class="project-details top-desktop">
                    ...
                    <a class="ref-button" href="{{ route('specialist.specialist-payment-detail', [$obj_job->id]) }}"> button </a>
                ...
                <div class="pay-bottom">
                  <ul class="pay-list">
                    <li>
                      <span>Total Paid:</span><strong>$ {{ $obj_job->getSpecialistTotalPayment() }}</strong>
                    </li>
                    <li>
                      <span>Total Outstanding:</span><strong>$ {{ $obj_job->getSpecialistOutstandingPayment() }}</strong>
                    </li>
                  </ul>
                </div>  
              </div>
