            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="portlet-title">
                        <div class="caption">
                            <h4 class="caption-subject bold uppercase">
                                <i class="fa fa-plus"></i>&nbspCreate New Specialist
                            </h4>
                        </div>
                    </div>
                    ...
                    <div class="portlet-body form margin-top-25">
                        <form method="POST" action="{{ route('specialists.specialist.store') }}" accept-charset="UTF-8" id="create_specialist_form" name="create_specialist_form" enctype="multipart/form-data">
                            <div class="form-body">
                                {{ csrf_field() }}
