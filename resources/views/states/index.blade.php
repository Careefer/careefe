            ...
            <div class="col-md-12">
                ...
                <div class="portlet-title">
                    <div class="caption font-dark">
                        <h4 class="caption-subject bold uppercase"><i class="fa fa-list"></i>&nbspManage States
                        </h4>
                    </div>
                    <div class="actions">
                            <div class="btn-group">
                                <button class="btn sbold green" onclick="redirect_url($(this),'{{ route('states.state.create') }}');"><i class="fa fa-plus"></i>
                                 Add State
                                </button>
                            </div>
                    </div>            
                            ...
                            <table class="table table-striped table-bordered table-hover dt-responsive table-checkable service-table" id="datatable_ajax">
                                <thead>
                                    <tr role="row" class="heading">
                                        <th width="350" class="all">State</th>
                                    ...
                                    <tr class="filter" role="row">    
                                        ...
                                        <td rowspan="1" colspan="1">
                                           <div class="margin-bottom-5">
                                            <input type="text" placeholder="State" name="name" id="name" class="form-control form-filter input-sm">
                                            </div>
                                        </td>
...
@push('scripts')
    ...
    <script>
       $(document).ready(function() {
        src = "{{ route('states.state.allStates') }}";
         $("#name").autocomplete({
